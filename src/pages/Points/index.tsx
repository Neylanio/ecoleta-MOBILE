...
const Points = () => {
    ...
    useEffect(() => {
      async function loadPosition(){
        ...
        if(status !== 'granted'){
          Alert.alert('Oooops...', 'Precisamos de sua permissão para obtermos a localização');
          return;
        }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <View style={styles.mapContainer}>
                  {/* condicional ternario possivel no React */}
                  {initialPosition[0] !== 0 && (
                    <MapView 
                        style={styles.map}
                        initialRegion={{
                    ...
                    >
                      {/* fazer um migrate refresh e colocar latitude e longitude como integer */}
                      {points.map(point => (
                        <Marker 
                            key={String(point.id)}
